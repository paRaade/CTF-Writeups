...
The mysql file has an md5 hash. I took the hash: 42f749ade7f9e195bf475f37a44cafcb and used crackstation to get it's plaintext password Password123. The username is manager
```
...
```
Using the following credentials I was able to successfully login to SweetRice with the following credentials:
